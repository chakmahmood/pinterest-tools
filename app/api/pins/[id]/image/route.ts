  ...
  try {
    ...
    if (pin.imageUrl) {
      ...
      try {
        ...
        console.log("🌐 R2_PUBLIC_URL configured:", Boolean(publicUrl));
    ...
    console.log("R2_BUCKET_NAME exists:", Boolean(process.env.R2_BUCKET_NAME));

    console.log("R2_PUBLIC_URL exists:", Boolean(process.env.R2_PUBLIC_URL));
